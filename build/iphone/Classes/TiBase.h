...
// in simulator we redefine to format for KievTours Developer console
...
{\
	NSString * exceptionName = [@"org.kievtours." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.kievtours";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIKievToursNativeItemNone = -1, 
	UIKievToursNativeItemSpinner = -2,
	UIKievToursNativeItemProgressBar = -3,
	
	UIKievToursNativeItemSlider = -4,
	UIKievToursNativeItemSwitch = -5,
	UIKievToursNativeItemMultiButton = -6,
	UIKievToursNativeItemSegmented = -7,
	
	UIKievToursNativeItemTextView = -8,
	UIKievToursNativeItemTextField = -9,
	UIKievToursNativeItemSearchBar = -10,
	
	UIKievToursNativeItemPicker = -11,
	UIKievToursNativeItemDatePicker = -12,
	
	UIKievToursNativeItemInfoLight = -13,
	UIKievToursNativeItemInfoDark = -14,
	
	UIKievToursNativeItemDisclosure = -15,
	
	UIKievToursNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all KievTours instances of
