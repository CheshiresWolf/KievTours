...
@interface KievToursObject : KrollCoverageObject {
#else
@interface KievToursObject : KrollObject {
#endif
@private
...
extern NSString * KievTours$ModuleRequireFormat;
