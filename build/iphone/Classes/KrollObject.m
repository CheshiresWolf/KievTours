...
//@interface KievToursObject : NSObject
//@end

@interface KievToursObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[KievToursObject class]])
		{
			for (NSString *key in [[(KievToursObject*)o modules] allKeys])
			{
