...
/**
 Base class for all KievTours views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the KievTours view hierarchy (such as wrapped iOS UIViews) was touched.
